...
def TaxInc(c00100, standard, c04470, c04600, MARS, e00900, e26270,
           ...
           PT_qbid_w2_wages_rt, PT_qbid_ps, PT_qbid_prt,
    ...
    if qbinc > 0. and PT_qbid_rt > 0.:
        ...
        # Apply phase-out of QBID
        phaseout_excess = max(0., pre_qbid_taxinc - PT_qbid_ps[MARS - 1])
        qbided = max(0., qbided - phaseout_excess * PT_qbid_prt)            
...
@iterate_jit(nopython=True)
def RetirementSavingCredit(RetirementSaving_crt, e03150, e03300,
                           retirement_saving_credit):
    """
    Computes credit for contributions to retirement savings plans.
        e03150 : Total deductible IRA plan contributions

        e03300 : Total deductible KEOGH/SEP/SIMPLE/etc. plan contributions
    """
    retirement_saving_credit = (RetirementSaving_crt *
                                (e03150 + e03300))
    return retirement_saving_credit


@iterate_jit(nopython=True)
def IITAX(c59660, c11070, c10960, personal_refundable_credit, ctc_new, rptc,
          c09200, payrolltax, retirement_saving_credit,
          eitc, refund, iitax, combined):
    """
    Computes final taxes.
    """
    eitc = c59660
    refund = (eitc + c11070 + c10960 + retirement_saving_credit +
