...
import pandas as pd
import paramtools
from tclocal.calcfunctions import (TaxInc, SchXYZTax, GainsTax, AGIsurtax,
                                   ...
                                   CharityCredit, RetirementSavingCredit,
                                   NonrefundableCredits, C1040, IITAX,
                                   BenefitSurtax, BenefitLimitation,
                                   FairShareTax, LumpSumTax, BenefitPrograms,
                                   ExpandIncome, AfterTaxIncome)
from tclocal.policy import Policy
from tclocal.records import Records
from tclocal.consumption import Consumption
from tclocal.growdiff import GrowDiff
from tclocal.growfactors import GrowFactors
from tclocal.utils import (DIST_VARIABLES, create_distribution_table,
...
class Calculator():
    ...
    def _calc_one_year(self, zero_out_calc_vars=False):
        ...
        RetirementSavingCredit(self.__policy, self.__records)
